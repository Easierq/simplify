      ...
      <body className={cn(inter.className, "bg-white dark:bg-black")}>
        ...
        >
          <div className="absolute top-0 -z-10 h-full w-full bg-white dark:bg-black">
            ...
            {/* <div className="absolute bottom-auto left-auto right-0 top-0 h-[500px] w-[500px] -translate-x-[30%] translate-y-[20%] rounded-full bg-[rgba(109,224,244,0.6)] md:bg-[rgba(109,224,244,0.8)] opacity-50 blur-[80px]"></div> */}
          </div>
